  ...
  [177],
  {
    ...
    552: (e, t, s) => {
              ...
              children:
                "dark" === s
                  ...
                  : (0, l.jsxs)("svg", {
                      ...
                      strokeLinejoin: "round",
                      children: [
                        (0, l.jsx)("circle", { cx: "12", cy: "12", r: "5" }),
                        (0, l.jsx)("line", {
                          x1: "12",
                          y1: "1",
                          x2: "12",
      ...
      let o = () => {
        (0, r.useEffect)(() => {
          !(function () {
            let e = document.querySelectorAll(".animate-on-scroll"),
              t = new IntersectionObserver(
                (e) => {
                  e.forEach((e) => {
                    console.log(e),
                      e.isIntersecting && e.intersectionRatio > 0.2
                        ? e.target.classList.add("show-animate")
                        : e.target.classList.remove("show-animate");
                  });
                },
                { threshold: 0.2 }
              );
            ...
            children: (0, l.jsx)("div", {
              ...
              children: (0, l.jsxs)("div", {
                ...
                children: [
                  (0, l.jsxs)("a", {
                    href: "/",
                    className: "btn navbar-bubble link ".concat(
                      "/" === e || "/home" === e ? "active" : ""
                    ),
                    id: "home",
                    children: [
    ...
    1362: (e, t, s) => {
      ...
      var l = s(2115),
        r = (e, t, s, l, r, n, a, i) => {
          ...
          function d(t) {
            ...
            (Array.isArray(e) ? e : [e]).forEach((e) => {
              ...
              (s = t),
              i && c.includes(s) && (o.style.colorScheme = s);
          }
          if (l) d(l);
          else
            try {
        ...
        c = () => {
          var e;
          return null != (e = l.useContext(i)) ? e : o;
        },
        d = (e) =>
          l.useContext(i)
        ...
        m = (e) => {
          let {
            ...
            [y, j] = l.useState(() => x(c, m)),
            [N, k] = l.useState(() => ("system" === y ? f() : y)),
            ...
            S = l.useCallback(
              (e) => {
                ...
                let l = b ? b[t] : t,
                  ...
                  c = (e) => {
                    "class" === e
                      ? (i.classList.remove(..._), l && i.classList.add(l))
                      : e.startsWith("data-") &&
                        (l ? i.setAttribute(e, l) : i.removeAttribute(e));
                  };
                if ((Array.isArray(g) ? g.forEach(c) : c(g), o)) {
            ...
            H = l.useCallback(
              (e) => {
                k(f(e)), "system" === y && r && !t && S("system");
              },
              [y, t]
            );
          l.useEffect(() => {
            let e = window.matchMedia(a);
            return e.addListener(H), H(e), () => e.removeListener(H);
          }, [H]),
            l.useEffect(() => {
              let e = (e) => {
                e.key === c && (e.newValue ? j(e.newValue) : M(m));
              };
              return (
        ...
        C = l.memo((e) => {
          let {
            ...
            C = JSON.stringify([n, s, o, t, d, c, a, i]).slice(1, -1);
          return l.createElement("script", {
            ...m,
            suppressHydrationWarning: !0,
            nonce: "",
            dangerouslySetInnerHTML: {
              __html: "(".concat(r.toString(), ")(").concat(C, ")"),
            },
          });
        }),
        x = (e, t) => {
          ...
          (0, l.jsxs)(l.Fragment, {
            children: [
              e &&
                (0, l.jsxs)("div", {
                  className:
                    "fixed bottom-[100px] right-5 z-40 w-80 h-[400px] bg-bubble rounded-lg shadow-xl flex flex-col animate-fade-in-up",
                  children: [
                    (0, l.jsxs)("div", {
                      className:
                        "header bg-primary text-white p-3 rounded-t-lg flex justify-between items-center",
                      children: [
                        (0, l.jsxs)("div", {
                          ...
                          children: [
                            ...
                            (0, l.jsx)("div", {
                              className: "flex col avatar-name text-secondary",
                              children: "Jivi",
                            }),
                          ],
                        }),
                    ...
                    (0, l.jsxs)("div", {
                      className:
                        "body p-4 flex-grow overflow-y-auto animate-slide-up-fade",
                      children: [
                        (0, l.jsx)("div", {
                          ...
                          children: "2 Unread Message",
                        }),
                        (0, l.jsx)("div", {
                          className: "flex justify-start",
                          children: (0, l.jsx)("div", {
                            className:
                              "bot-message bg-gray-200 text-gray-800 pl-3  pr-2 pb-1 rounded-lg max-w-[80%]",
                            children: (0, l.jsxs)("p", {
                              children: [
                                (0, l.jsxs)("span", {
                                  className: "text-sm",
                                ...
                                (0, l.jsx)("span", {
                                  ...
                                  className:
                                    "float-end text-[10px] text-gray-500 ",
                                  children: i,
                                }),
                              ],
                            }),
                    ...
                    (0, l.jsx)("div", {
                      className: "footer p-2  border-t border-gray-200 ",
                      children: (0, l.jsxs)("form", {
                        onSubmit: (e) => {
                          if ((e.preventDefault(), !s.trim())) return;
                          let l = encodeURIComponent(s),
                            r = "https://wa.me/"
                              .concat("6282120741970", "?text=")
                              .concat(l);
                          window.open(r, "_blank"), n(""), t(!1);
                        },
                        ...
                        children: [
                          (0, l.jsx)("input", {
                            ...
                            className:
                              "flex-grow text-secondary p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500",
                            autoFocus: !0,
                          }),
                          (0, l.jsx)("button", {
                            type: "submit",
                            className:
                              "bg-green-600 text-white p-2 rounded-full hover:bg-green-700 transition-colors link",
                            children: (0, l.jsxs)("svg", {
                              width: "25",
                              viewBox: "0 0 24 24",
                              fill: "none",
              ...
              (0, l.jsx)("button", {
                onClick: a,
                className: "fixed link bottom-5 right-5 z-50 w-16 h-16 ".concat(
                  e
    ...
    5659: (e, t, s) => {
      Promise.resolve().then(s.bind(s, 1362)),
        Promise.resolve().then(s.t.bind(s, 2093, 23)),
        Promise.resolve().then(s.t.bind(s, 7735, 23)),
        Promise.resolve().then(s.t.bind(s, 347, 23)),
        Promise.resolve().then(s.bind(s, 3808)),
        Promise.resolve().then(s.bind(s, 6985)),
        Promise.resolve().then(s.bind(s, 552));
    },
    6985: (e, t, s) => {
      "use strict";
      s.d(t, { default: () => a });
          ...
          children: (0, l.jsxs)("footer", {
            ...
            children: [
              ...
              (0, l.jsx)("div", {
                ...
                children:
                  "This tech stack using NextJS + ThreeJS + TailwindCSS by Jivi Muzaqi Guntur",
              }),
              (0, l.jsxs)("div", {
                className: "text-center mt-1 text-gray-500 text-xs",
                children: [
                  "\xa9 ",
                  new Date().getFullYear(),
                  " Jivi Muzaqi Guntur. All rights reserved.",
                ],
              }),
            ],
          }),
    ...
    9626: (e, t, s) => {
      ...
      function l(e) {
        let t = new Date(e),
          ...
          r = s.getMonth() - t.getMonth(),
          n = s.getDate() - t.getDate();
        return n < 0 && r--, r < 0 && l--, { years: l, months: r, days: n };
      }
      s.d(t, { Y: () => l });
    },
  },
  (e) => {
    e.O(0, [360, 348, 441, 964, 358], () => e((e.s = 5659))), (_N_E = e.O());
  },
]);
